        ...
        <View style={Styles.TableDropDownContainer}>
          <FlatList
            ...
            renderItem={({item, index}) => (
              <View style={{flex: 1}}>
                <View style={Styles.PerformanceReportTableContainer}>
                  <TouchableOpacity
                    onPress={() => toggleTable(index)}
                    style={Styles.PerformanceReportsTableHeadContainer}>
                    <View
                      style={{
                        flexDirection: 'row',
                        justifyContent: 'space-between',
                      }}>
                      <View style={Styles.PerformanceReportTableHeadText}>
                        <Text
                          style={[
                      ...
                      <View
                        style={[
                          Styles.PerformanceReportTableHeadText,
                          {marginLeft: hp('2%')},
                        ]}>
                    ...
                    {showTable[index] && (
                      <View
                        ...
                        <View style={Styles.tableSubTitleContainer}>
                          ...
                          <Text
                            style={[
                              Styles.performanceReportsTableSubTitles,
                              {paddingLeft: hp('2.3%')},
                            ]}>
                            Booking Value
                          </Text>
