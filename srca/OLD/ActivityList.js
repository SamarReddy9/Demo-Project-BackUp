...
const ActivityList = props => {
  ...
  const [readMoreHide, setReadMoreHide] = useState(false);
  ...
  const options = ['Daily Standup Meeting', 'Training Session', 'Other'];
              ...
              <ScrollView
                ...
                <View style={styles.dropDownDefaultItemContainer}>
                  <TouchableOpacity
                    ...
                    {showDropdown ? (
                      <ArrowRight style={styles.dropDownArrowIcon} />
                    ) : (
                      <ArrowDown style={{marginRight: hp('1.5%')}} />
                    )}
                  </TouchableOpacity>
...
//       activityType: 'Daily standup meeting',
//       meetingAgenda:
//         'Team hurdle lorem ipsum dolor sit amet. consectetuadipiscing elit.Team hurdle lorem ipsum dolor sit amet.',
//       hostImage:
//         'https://c.ndtvimg.com/2022-03/6r4tpe2o_ys-jagan-mohan-reddyani_625x300_24_March_22.jpg',
//       hostName: 'Pradeep Kumar',
//       hostPosition: 'Project Head',
...
//   <Text
//     numberOfLines={
//       showMore ? (a === item.id ? undefined : 2) : 2
//     }
//     style={styles.meetingAgenda}>
//     {item.meetingAgenda}
//   </Text>
...
//       activityType: 'Daily standup meeting',
//       meetingAgenda:
//         'Team hurdle lorem ipsum dolor sit amet. consectetur adipiscing elit.The color rose sits between red and magenta and is one  of the main colors associated with love and romance  The color rose sits between red and magenta and is one  of the main colors associated with love and romance.',
//       hostImage:
//         'https://c.ndtvimg.com/2022-03/6r4tpe2o_ys-jagan-mohan-reddyani_625x300_24_March_22.jpg',
//       hostName: 'Pradeep Kumar',
//       hostPosition: 'Project Head',
