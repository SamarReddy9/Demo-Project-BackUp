            ...
            <View style={Styles.tableContainer}>
              <TouchableOpacity
                ...
                <View style={{flexDirection: 'row'}}>
                  ...
                  <View style={[Styles.tableHeadText, {marginLeft: 37}]}>
                  ...
                  <View style={[Styles.tableHeadText, {marginLeft: 29}]}>
                    <Text style={Styles.tableHeaderTopLayerText}>Units</Text>
                    <Text style={Styles.bhkTableTitle}>
                      {BookingUnitValueOne}
                    </Text>
                  </View>
                  <View style={[Styles.tableHeadText, {marginLeft: 50}]}>
                    <Text style={Styles.tableHeaderTopLayerText}>
                      Percentage
                    </Text>
                    <Text style={Styles.bhkTableTitle}>
                ...
                {showTableBHKOne && (
                  <View
                    ...
                    <View style={Styles.tableSubTitleContainer}>
                      <Text style={Styles.tableSubTitles}>Budget</Text>
                      <Text style={Styles.tableSubTitles}>Booking Value</Text>
                      <Text style={[Styles.tableSubTitles, {marginLeft: 20}]}>
                        Units
                      </Text>
                      <Text style={Styles.tableSubTitles}>Percentage</Text>
                    </View>
                    {tableData.map((item, index) => (
                      <View style={Styles.tableRow} key={index}>
                        <Text style={Styles.tableCell}>{item.budget}</Text>
            ...
            <View style={Styles.tableContainer}>
              <TouchableOpacity
                ...
                <View style={{flexDirection: 'row'}}>
                  ...
                  <View
                    style={[Styles.tableHeadText, {marginLeft: hp('3.7%')}]}>
                    <Text style={Styles.tableHeaderTopLayerText}>
                      Booking value
                    </Text>
                    <Text style={Styles.bhkTableTitle}>
                  ...
                  <View
                    style={[Styles.tableHeadText, {marginLeft: hp('2.9%')}]}>
                    <Text style={Styles.tableHeaderTopLayerText}>Units</Text>
                    <Text style={Styles.bhkTableTitle}>
                      {BookingUnitValueThree}
                    </Text>
                  </View>
                  <View style={[Styles.tableHeadText, {marginLeft: hp('5%')}]}>
                    <Text style={Styles.tableHeaderTopLayerText}>
                      Percentage
                    </Text>
                    <Text style={Styles.bhkTableTitle}>
                ...
                {showTableBHKThree && (
                  <View
                    ...
                    <View style={Styles.tableSubTitleContainer}>
                      ...
                      <Text style={Styles.tableSubTitles}>Booking Value</Text>
                      <Text
                        style={[Styles.tableSubTitles, {marginLeft: hp('3%')}]}>
                        Units
                      </Text>
                      <Text style={Styles.tableSubTitles}>Percentage</Text>
                    </View>
